...
public class MenuClick : MonoBehaviour {
	...
	void Awake()
	{
		...
		Debug.Log (LevelManager.prevLevel);
		LevelMenu2D.I.OnItemClicked += OnItemClicked;
		if (LevelManager.prevLevel == "Level_01_Win" || LevelManager.prevLevel == "Level_01") {
			LevelMenu2D.I.initialItemNumber = 1;
		} else if (LevelManager.prevLevel == "Level_02_Win" || LevelManager.prevLevel == "Level_02") {
			LevelMenu2D.I.initialItemNumber = 2;
		} else if (LevelManager.prevLevel == "Level_03_Win" || LevelManager.prevLevel == "Level_03") {
			LevelMenu2D.I.initialItemNumber = 3;
		} else if (LevelManager.prevLevel == "Level_04_Win" || LevelManager.prevLevel == "Level_04") {
			LevelMenu2D.I.initialItemNumber = 4;
		} else if (LevelManager.prevLevel == "Level_05_Win" || LevelManager.prevLevel == "Level_05") {
			LevelMenu2D.I.initialItemNumber = 5;
		} else if (LevelManager.prevLevel == "Level_06") {
			LevelMenu2D.I.initialItemNumber = 6;
		}
	}
